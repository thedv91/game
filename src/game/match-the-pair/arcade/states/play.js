...
class Play extends Phaser.State {
	...
	createIntro() {
		...
		const lineHR = this.game.add.tileSprite(w / 2, h / 2 - this.game.screenData.intro_margin_top, instructions.width, 2, 'green-dark');
		...
		cc.addChild(bg);
		cc.addChild(instructions);
		cc.addChild(lineHR);
		cc.addChild(text_pause);
		cc.addChild(this.okBtn);
